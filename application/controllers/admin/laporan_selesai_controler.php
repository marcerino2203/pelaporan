...
class Laporan_selesai_controler extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('admin/laporan_selesai/index', $data);
	}
	public function detail($id_instansi)
	{
		$data['laporan'] = $this->admin_model->get_laporan_status($id_instansi, 4);
		$data['instansi'] = $this->admin_model->get_details_instansi($id_instansi);
		$this->load->view('admin/laporan_selesai/detail', $data);
	}
	public function detail_laporan($id_aduan)
	{
		$data['laporan_detail'] = $this->admin_model->get_laporan_detail($id_aduan);
		$this->load->view('admin/laporan_selesai/detail_laporan', $data);
	}
}
