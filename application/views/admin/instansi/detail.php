  ...
  <div class="wrapper">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?php echo base_url() ?>index.php/admin/instansi_controler" class="nav-link active">
    ...
    <div class="content-wrapper">
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="card">
            <div class="card-header">Detail Instansi</div>
            <div class="card-body">
              <?php
              foreach ($detail_instansi->result_array() as $data_instansi) :
                $id_instansi = $data_instansi['id_instansi'];
                $nama = $data_instansi['nama'];
                $alamat = $data_instansi['alamat'];
                $telp = $data_instansi['telp'];
              endforeach;
              ?>
