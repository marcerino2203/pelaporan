        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Laporan Dalam Proses</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <div class="card">
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo base_url() ?>index.php/admin/laporan_ditangguhkan_controler/detail_laporan/<?= $data_laporan['id_aduan'] ?>">
