    ...
    <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
      <div class="container">
        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a href="<?php echo base_url() ?>aduanlist_nonlog_control" class="">
                <div class="nav-link">
                  Aduan Masuk
                </div>
              </a>
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
        <li class="nav nav-item">
          <a href="<?php echo base_url() ?>daftar_controler" class="">
            <div class="nav-link">
              Daftar
            </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 float-right">
              <div class="card">
                ...
                <div class="card-body">
                  <?php echo form_open_multipart('Home_model/add_aduan') ?>
